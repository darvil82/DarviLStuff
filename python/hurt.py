...
"""Shitty quick thing i did, expect the stupid."""
...
def parseArgs():
	...
	argparser.add_argument("-v", "--verbose", help="Output all the content to stdout", action="store_true")
...
def capValue(value ,max=None, min=None):
...
def main():
	...
	if (args.verbose or args.string) or not args.output:
		for byte in byteArr:
